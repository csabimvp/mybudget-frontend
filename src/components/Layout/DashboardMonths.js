export default function DashboardMonths({ data = {} }) {
    ...
    return (
        ...
        <div className='dashboard-month-wrapper col-6'>
            ...
            <hr className='mt-2' />
            <p>Expense: <span className='dashboard-expense-value'><strong>{Math.round(expense_percent * 100)}%</strong></span> -·- Saving: <span className='dashboard-saving-value'><strong>{Math.rond(saving_percent * 100)}%</strong></span></p>
        </div>
