...
export default function ModellerNavBar({ year = [], month = [], yearFilter = {}, monthFilter = {}, onYearFilter = f => f, onMonthFilter = f => f, onResetFilter = f => f }) {
    ...
    return (
        <nav className="mynavbar navbar navbar-expand-lg">
            <div className="container-fluid">
                <h1 className="navbar-brand">Csaba's Budget</h1>
                        ...
                        <li className="nav-item">
                            <div className="dash-filter">
                                <div className="dropend">
                                    ...
                                    <ul className="dropdown-menu">
                                        {
                                            filteredMonths.map(m => <FilterDropDown key={m.id} {...m} onFilter={onMonthFilter} />)
                                        }
                                    </ul>
                                </div>
                            </div>
